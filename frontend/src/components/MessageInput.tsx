        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-2 border-t border-gray-700 pt-2'>
            {
                imageFile && <div className='relative w-fit'>
                    ...
                    <button className='absolute -top-2 -right-2 bg-black rounded-full p-1' type='button' onClick={() => setImageFile(null)}>
            ...
            <div className="flex items-center gap-2">
                ...
                <input
                    type="text"
                    className='flex-1 bg-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-400 ' placeholder={imageFile ? "Add a caption..." : "Type a message..."}
                    value={message}
