            ...
            <div className='max-w-md w-full'>
                <div className='bg-gray-800 border border-gray-700 rounded-lg p-8'>
                    <div className='text-center mb-8 relative'>
                        <button className='absolute top-0 left-0 p-2 text-gray-300 hover:text-white cursor-pointer' onClick={() => router.push(`/login`)}>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        <div>
                            ...
                            <div className='flex justify-center in-checked: space-x-3'>
                                {otp.map((digit, index) => (
                                    <input
                                        key={index} ref={(el: HTMLInputElement | null) => {
                    ...
                    <div className='mt-6 text-center'>
                        <p className='text-gray-400 text-sm mb-4'>Didn&apos;t received the code?</p>
                        {timer > 0 ? <p className='text-gray-400 text-sm'>Resend Code in {timer} seconds </p> : (<button onClick={handleResendOtp} disabled={resendLoading} className='text-blue-400 hover:text-blue-300 font-medium text-sm disabled:opacity-50'>
