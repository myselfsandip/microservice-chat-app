...
const ProfilePage = () => {
    ...
    const submitHandler = async (e: any) => {
        ...
        try {
            const data = await userApi.editProfile(name);
        ...
        <div className="min-h-screen bg-gray-900 p-4 ">
            <div className="max-w-2xl mx-auto pt-8">
                <div className="flex items-center gap-4 mb-8">
                    <button className="p-3 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 " onClick={() => router.push("/chat")}>
